...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  "SELECT project.title, SUM(pledge.amount) FROM project JOIN pledge ON project.id = pledge.project_id GROUP BY HAVING project.funding_goal = SUM(pledge.amounnt)"
end
